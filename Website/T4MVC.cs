...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string dracula_graffle_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/dracula_graffle.min.js") ? Url("dracula_graffle.min.js") : Url("dracula_graffle.js");
                      
        public static readonly string dracula_graph_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/dracula_graph.min.js") ? Url("dracula_graph.min.js") : Url("dracula_graph.js");
